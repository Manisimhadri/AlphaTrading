...
import {
  ...
  SEARCH_COIN_REQUEST, SEARCH_COIN_SUCCESS, SEARCH_COIN_FAILURE,
  FETCH_TOP_GAINERS_REQUEST, FETCH_TOP_GAINERS_SUCCESS, FETCH_TOP_GAINERS_FAILURE,
  FETCH_TOP_LOSERS_REQUEST, FETCH_TOP_LOSERS_SUCCESS, FETCH_TOP_LOSERS_FAILURE,
  FETCH_TRADING_COINS_REQUEST, FETCH_TRADING_COINS_SUCCESS, FETCH_TRADING_COINS_FAILURE
} from "./ActionTypes";
...
const initialState = {
  ...
  coinById: null,
  coinDetails: null,
  tradingCoins: [], // added for trading coins
  loading: false,
  error: null,
};
...
const coinReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case FETCH_TRADING_COINS_REQUEST: // added case
      return { ...state, loading: true, error: null };
    ...
    case FETCH_TRADING_COINS_SUCCESS: // added case
      return {
        ...state,
        tradingCoins: action.payload,
        loading: false,
        error: null,
      };
    ...
    case FETCH_TRADING_COINS_FAILURE: // added case
      return { ...state, loading: false, error: action.payload };
