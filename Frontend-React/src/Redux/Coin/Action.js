...
import { FETCH_COIN_BY_ID_FAILURE, FETCH_COIN_BY_ID_REQUEST, FETCH_COIN_BY_ID_SUCCESS, FETCH_COIN_DETAILS_FAILURE, FETCH_COIN_DETAILS_REQUEST, FETCH_COIN_DETAILS_SUCCESS, FETCH_COIN_LIST_FAILURE, FETCH_COIN_LIST_REQUEST, FETCH_COIN_LIST_SUCCESS, FETCH_MARKET_CHART_FAILURE, FETCH_MARKET_CHART_REQUEST, FETCH_MARKET_CHART_SUCCESS, FETCH_TOP_50_COINS_FAILURE, FETCH_TOP_50_COINS_REQUEST, FETCH_TOP_50_COINS_SUCCESS, FETCH_TOP_GAINERS_FAILURE, FETCH_TOP_GAINERS_REQUEST, FETCH_TOP_GAINERS_SUCCESS, FETCH_TOP_LOSERS_FAILURE, FETCH_TOP_LOSERS_REQUEST, FETCH_TOP_LOSERS_SUCCESS, FETCH_TRADING_COINS_FAILURE, FETCH_TRADING_COINS_REQUEST, FETCH_TRADING_COINS_SUCCESS, SEARCH_COIN_FAILURE, SEARCH_COIN_REQUEST, SEARCH_COIN_SUCCESS } from "./ActionTypes";
...
export const fetchCoinList = (page) => async (dispatch) => {
  ...
  export const fetchTopGainers = () => async (dispatch) => {
    ...
    try {
        ...
        console.log("top gainers", response.data);
    } catch (error) {
        console.log("error", error);
...
export const fetchTopLosers = () => async (dispatch) => {
    ...
    try {
        ...
        console.log("top losers", response.data);
    } catch (error) {
        console.log("error", error);
