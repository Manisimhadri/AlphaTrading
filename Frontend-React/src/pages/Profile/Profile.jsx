  ...
  return (
    <div className="flex flex-col items-center mb-5">
      <div className="pt-10 w-full lg:w-[60%]">
            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"20/10/2003"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"code with anil"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">City : </p>
                  <p className="text-gray-500">{"east godavari"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Postcode : </p>
                  <p className="text-gray-500">{534313} </p>
                </div>
                <div className="flex">
        ...
        {/* <Button onClick={handleLogout} className="bg-blue-500 text-white border-none mt-6 hover:bg-blue-700">Logout</Button> */}
      </div>
    </div>
  );
};
